...
public class ModelSPCT {
    ...
    public ModelSPCT(String maSPCT, String maSP, String tenSanPham, String tenMauSac, String tenChatLieu, String tenKichThuoc, String tenXuatXu, String tenThuongHieu, int soLuong, double donGia, boolean trangThai) {
        this.maSPCT = maSPCT;
        this.maSP = maSP;
    ...
    public ModelSPCT(int soLuong, double donGia, int maSanPham, int maChatLieu, int maMauSac, int maKichThuoc, int maXuatXu) {
        this.soLuong = soLuong;
        this.donGia = donGia;
    ...
    public ModelSPCT(int soLuong, double donGia, String maSPCT, int maSanPham, int maChatLieu, int maMauSac, int maKichThuoc, int maXuatXu) {
        this.soLuong = soLuong;
        this.donGia = donGia;
        this.maSPCT = maSPCT;
        this.maSanPham = maSanPham;
    ...
    public ModelSPCT(String tenSanPham) {
        this.tenSanPham = tenSanPham;
    }

    public ModelSPCT(String maSP, String tenSanPham) {
        this.maSP = maSP;
        this.tenSanPham = tenSanPham;
    }
